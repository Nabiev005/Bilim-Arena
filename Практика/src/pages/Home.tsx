...
const Home: React.FC = () => {
  ...
  const games = [
    ...
    },
    {
      ...
      icon: '🌳',
      color: '#E3F2FD', // Ачык көк түс, Ак терекке ылайыктуу
      path: '/ak-terek',
      status: 'Жаңы',
      category: 'Тил',
      players: '0'
    },
    {
      ...
      icon: '🏛️',
      color: '#FFF3E0', // Жумшак сары/алтын түс, тарыхка ылайыктуу
      path: '/history',
      status: 'Популярдуу',
      category: 'Тарых',
      players: '100+'
    ...
    },
    {
      ...
      description: 'Улакты казанга так таштаңыз! Математикалык амалдарды колдонуп, эң кыска жол менен жеңишке жетиңиз.',
      icon: '🐎', // Аттын же улактын иконкасы
      color: '#065f46', // Көк-Бөрү талаасынын кочкул жашыл түсү
      path: '/kok-boru-game',
      status: 'Жаңы',
      category: 'Логика', // Же 'Математика' деп койсоң болот
      players: '100+'
    }, 
    {
      id: 'cyber-shield',
      ...
      icon: '🛡️', // Же '💻' иконкасын колдонсоңуз болот
      color: '#0a0a0c', // Киберпанк стилиндеги кара-жашыл түс
      path: '/cyber-shield', // Бул жерге CyberShield.tsx файлына баруучу жолду жазыңыз
      status: 'Жаңы',
      category: 'IT & Логика',
      players: '50+'
    },
